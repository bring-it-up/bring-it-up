...
import { ALL_FILTER_OPTION, convertEnumToFilterOptions, convertSchoolsToFilterOptions, convertSpecialtiesToFilterOptions } from '../utils/filters.utils';
...
const Home = (): ReactElement => {
	...
	const convertFiltersToQueryStr = (filters: Filters): string => {
		...
		Object.values(filters).forEach((filter) => {
			...
			if (!filter.multiSelect && filter.options.find(o => o.value === ALL_FILTER_OPTION.value)?.selected) return; // 'All' selected, so skip
